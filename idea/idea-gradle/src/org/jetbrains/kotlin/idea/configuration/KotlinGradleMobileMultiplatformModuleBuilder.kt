...
<android.support.constraint.ConstraintLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    override fun buildMultiPlatformPart(): String {
        return """
            ...
            // This task attaches native framework built from ios module to Xcode (r) project
            // (see iosApp directory). Don't run this task directly,
            // Xcode (r) runs this task itself during its build process.
            // Before opening the project from iosApp directory in Xcode (r),
